...
"")
        ...
        self.Arduino.setGeometry(QtCore.QRect(120, 20, 140, 20))
        self.Arduino.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.Arduino.setObjectName("Arduino")
        self.Osi = QtWidgets.QComboBox(Dialog)
        self.Osi.setGeometry(QtCore.QRect(120, 60, 140, 20))
        self.Osi.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.Osi.setObjectName("Osi")
        self.Twin = QtWidgets.QComboBox(Dialog)
        self.Twin.setGeometry(QtCore.QRect(120, 100, 140, 20))
        self.Twin.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.Twin.setObjectName("Twin")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(20, 20, 100, 20))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(20, 100, 100, 20))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(20, 60, 100, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Cài Đặt Drive "))
